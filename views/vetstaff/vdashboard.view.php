...
<div class="container py-4">
    <h2 class="mb-4 text-center">Vet Staff Dashboard</h2>
    <div class="row mb-4">
        <div class="col-md-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <a href="/PetSpot_clinic/public/vetstaff/add-health-record" class="text-decoration-none">
                <div class="card text-center dashboard-card h-100 p-3">
        ...
        <!-- Blogs Card -->
        <div class="col-md-4">
            <a href="/PetSpot_clinic/public/vetstaff/blogs" class="text-decoration-none">
                <div class="card text-center dashboard-card h-100 p-3">
                    <div class="icon text-info"><i class="bi bi-journal-text"></i></div>
                    <h5 class="card-title">Blogs</h5>
                    <p class="card-text text-muted">View and manage clinic and user blogs.</p>
                </div>
            </a>
        </div>
