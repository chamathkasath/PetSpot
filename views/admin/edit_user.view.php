...
<head>
    <meta charset="UTF-8">
    <title>Edit Pet Owner | PetSpot Clinic Admin</title>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="container py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="bi bi-people-fill me-2"></i>Edit Pet Owner</h2>
                    <a href="/PetSpot_clinic/public/admin/users" class="btn btn-secondary">
                        <i class="bi bi-arrow-left"></i> Back to Pet Owners
                    </a>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="mb-0">Pet Owner Details</h4>
                            </div>
                            <div class="card-body">
                                <?php if (isset($user) && $user): ?>
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <small class="text-muted"><strong>User ID:</strong> <?= htmlspecialchars($user->user_ID) ?></small>
                                                </div>
                                                <div class="col-md-6">
                                                    <?php if (!empty($user->created_at)): ?>
                                                        <small class="text-muted"><strong>Registered:</strong> <?= date('M d, Y h:i A', strtotime($user->created_at)) ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="/PetSpot_clinic/public/admin/users" class="btn btn-secondary">Cancel</a>
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bi bi-check-circle"></i> Update Pet Owner
                                            </button>
                                        </div>
                                    </form>
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <h5 class="text-muted">Pet owner not found</h5>
                                        <a href="/PetSpot_clinic/public/admin/users" class="btn btn-primary mt-3">Back to Pet Owners</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
