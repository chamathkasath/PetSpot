...
<head>
    <meta charset="UTF-8">
    <title>Add Found Pet | PetSpot Clinic Admin</title>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="mb-0">Found Pet Information</h4>
                                <small class="text-muted">Enter details about the found pet</small>
                            </div>
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="gender" class="form-control" placeholder="Male, Female, or Unknown">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="special_markings" class="form-control" rows="3" placeholder="Describe any distinctive features, markings, or characteristics"></textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="found_location" class="form-control" placeholder="Where was the pet found?" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="email" name="reporter_email" class="form-control" placeholder="Email of person who found the pet">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Status</label>
                                            <input type="text" name="status" class="form-control" placeholder="Unclaimed, Claimed, or Adopted" value="Unclaimed">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <small class="form-text text-muted">Upload a clear photo of the found pet (optional)</small>
                                    </div>

                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-primary">Add Found Pet</button>
